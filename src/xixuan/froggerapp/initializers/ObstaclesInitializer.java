...
public class ObstaclesInitializer implements Initializable {
	...
	public void initialize() { 
		...
		Obstacle obstacle1model = new Obstacle( "file:resources/images/obstacles/"+"truck1"+"Right.png", 120, 0, 649, 0.5); 
		...
		Obstacle obstacle2model = new Obstacle( "file:resources/images/obstacles/"+"truck1"+"Right.png", 120, 300, 649, 0.5); 
		...
		Obstacle obstacle3model = new Obstacle( "file:resources/images/obstacles/"+"truck1"+"Right.png", 120, 600, 649, 0.5);
		...
		Obstacle obstacle4model = new Obstacle( "file:resources/images/obstacles/"+ "car1Left.png", 50, 100, 597, -0.5);
		...
		Obstacle obstacle5model = new Obstacle( "file:resources/images/obstacles/"+"car1Left.png", 50, 250, 597, -0.5);
		...
		Obstacle obstacle6model = new Obstacle( "file:resources/images/obstacles/"+"car1Left.png", 50, 400, 597, -0.5);
		...
		Obstacle obstacle7model = new Obstacle( "file:resources/images/obstacles/"+"car1Left.png", 50, 550, 597, -0.5);
		...
		Obstacle obstacle8model = new Obstacle( "file:resources/images/obstacles/"+"truck2Right.png", 200, 0, 540, 0.5);
		...
		Obstacle obstacle9model = new Obstacle( "file:resources/images/obstacles/"+ "truck2Right.png", 200, 500, 540, 0.5);
		...
		Obstacle obstacle10model = new Obstacle( "file:resources/images/obstacles/"+"car1Left.png", 50, 500, 490, -2.5);
