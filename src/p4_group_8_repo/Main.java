...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		background.add(new Log("file:resources/log3.png", 152, 0, 175, 0.75));
		background.add(new Log("file:resources/log3.png", 152, 220, 175, 0.75));
		background.add(new Log("file:resources/log3.png", 152, 440, 175, 0.75));
		//background.add(new Log("file:resources/log3.png", 150, 0, 166, 0.75));
		background.add(new Log("file:resources/logs.png", 310, 0, 276, -2));
		background.add(new Log("file:resources/logs.png", 310, 400, 276, -2));
		//background.add(new Log("file:resources/logs.png", 300, 800, 276, -2));
		background.add(new Log("file:resources/log3.png", 152, 50, 329, 0.75));
		background.add(new Log("file:resources/log3.png", 152, 270, 329, 0.75));
		background.add(new Log("file:resources/log3.png", 152, 490, 329, 0.75));
		//background.add(new Log("file:resources/log3.png", 150, 570, 329, 0.75));
		
		
		//Add turtles to the background
		//Merge them into a single function
		...
		//Add obstacles(trucks, cars) to the background
