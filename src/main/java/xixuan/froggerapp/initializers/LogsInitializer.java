...
import main.java.xixuan.froggerapp.controllers.LogController;
...
public class LogsInitializer implements Initializable {
	...
	public void initialize() { 
		...
		logModels[0] = new Log("file:src/main/resources/images/logs/"+"logRight.png", 130, 0, 180, Frog.logRightIntersectSpeed); 
		logViews[0] = new LogView(background);
		logControllers[0] = new LogController(logModels[0], logViews[0]);
		logControllers[0].updateView();
		
		logModels[1] = new Log("file:src/main/resources/images/logs/"+"logRight.png", 130, 220, 180, Frog.logRightIntersectSpeed); 
		logViews[1] = new LogView(background);
		logControllers[1] = new LogController(logModels[1], logViews[1]);
		logControllers[1].updateView();
		
		logModels[2] = new Log("file:src/main/resources/images/logs/"+"logRight.png", 130, 440, 180, Frog.logRightIntersectSpeed); 
		logViews[2] = new LogView(background);
		logControllers[2] = new LogController(logModels[2], logViews[2]);
		logControllers[2].updateView();
		
		logModels[3] = new Log("file:src/main/resources/images/logs/"+"logLongLeft.png", 200, 0, 285, Frog.logLeftIntersectSpeed); 
		logViews[3] = new LogView(background);
		logControllers[3] = new LogController(logModels[3], logViews[3]);
		logControllers[3].updateView();
		
		logModels[4] = new Log("file:src/main/resources/images/logs/"+"logLeft.png", 130, 600, 285, Frog.logLeftIntersectSpeed); 
		logViews[4] = new LogView(background);
		logControllers[4] = new LogController(logModels[4], logViews[4]);
		logControllers[4].updateView();
	
		logModels[5] = new Log("file:src/main/resources/images/logs/"+"logRight.png", 130, 120, 335, Frog.logRightIntersectSpeed); 
		logViews[5] = new LogView(background);
		logControllers[5] = new LogController(logModels[5], logViews[5]);
		logControllers[5].updateView();
		
		logModels[6] = new Log("file:src/main/resources/images/logs/"+"logRight.png", 130, 340, 335, Frog.logRightIntersectSpeed); 
		logViews[6] = new LogView(background);
		logControllers[6] = new LogController(logModels[6], logViews[6]);
		logControllers[6].updateView();
		
		logModels[7] = new Log("file:src/main/resources/images/logs/"+"logLongRight.png", 200, 580, 335, Frog.logRightIntersectSpeed); 
