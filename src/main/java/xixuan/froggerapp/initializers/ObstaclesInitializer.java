...
import main.java.xixuan.froggerapp.controllers.ObstacleController;
...
public class ObstaclesInitializer implements Initializable {
	...
	public void initialize() { 
		...
		obstacleModels[0] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car1"+"Right.png", 50, 0, 653, rightSpeed); 
		...
		obstacleModels[1] = new Obstacle( "file:src/main/resources/images/obstacles/"+"truck1"+"Right.png", 120, 300, 653, rightSpeed); 
		...
		obstacleModels[2] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car2"+"Right.png", 50, 600, 653, rightSpeed); 
		...
		obstacleModels[3] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car1Left.png", 50, 100, 593, leftSpeed); 
		...
		obstacleModels[4] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car2Left.png", 50, 250, 597, leftSpeed); 
		...
		obstacleModels[5] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car1Left.png", 50, 400, 593, leftSpeed); 
		...
		obstacleModels[6] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car2Left.png", 50, 550, 597, leftSpeed); 
		...
		obstacleModels[7] = new Obstacle( "file:src/main/resources/images/obstacles/"+"truck2"+"Right.png", 200, 0, 540, rightSpeed); 
		...
		obstacleModels[8] = new Obstacle( "file:src/main/resources/images/obstacles/"+"truck2"+"Right.png", 200, 500, 540, rightSpeed); 
		...
		obstacleModels[9] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar.png", 50, 500, 486, -2.5); 
		...
		obstacleModels[10] = new Obstacle( "file:src/main/resources/images/obstacles/"+"car2Right.png", 50, 330, 540, rightSpeed); 
		...
		obstacleModels[11] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar2.png", 50, 1000, 540, 0); 
		...
		obstacleModels[12] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar.png", 50, 1000, 597, 0); 
		...
		obstacleModels[13] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar2.png", 50, 1000, 653, 0); 
		...
		obstacleModels[14] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar2.png", 50, 1000, 432, 0); 
		...
		obstacleModels[15] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar.png", 50, 1000, 378, 0); 
		...
		obstacleModels[16] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar2.png", 50, 1000, 327, 0); 
		...
		obstacleModels[17] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar.png", 50, 1000, 276, 0); 
		...
		obstacleModels[18] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar2.png", 50, 1000, 222, 0); 
		...
		obstacleModels[19] = new Obstacle( "file:src/main/resources/images/obstacles/"+"racingCar.png", 50, 1000, 164, 0); 
