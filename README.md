...
**Tested on**: Lab Machine & Mac Java 10 JavaFX 10.0.1(on Lab Machine) and 10.0.2 (on Mac) using Eclipse<br>
**Build script**: Maven - set this as goals in run configuration of Maven Build: <br>
